   ...
   return(
      <View style={[loginStyles.container, { backgroundColor: '#fff'}]}>
         ...
         <View style={styles.button}>
            <GradientButton style={{alignSelf:'center', padding: 5, width:'103%'}} gradientBegin='#ff9259' gradientEnd="#ff2426" text="Log In" textStyle={{ fontWeight: 'bold', color: '#fff' }} onPressAction={()=> navigation.navigate('SplashCourierLog')}/>
         </View>
         <View style={styles.button} >
            <GradientButton style={{alignSelf:'center', padding: 5, width:'103%'}} gradientBegin='#fff' gradientEnd='#ff9259' text="Sign In" textStyle={{ fontWeight: 'bold', color: '#000000' }} onPressAction={()=> navigation.navigate('SplashCourierSig')}/>
         </View>
